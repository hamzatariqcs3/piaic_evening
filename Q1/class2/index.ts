...
let sub = ns1 - ns2 - ns3; //subtract numbers using the +operator.

console.log(sub);   // Output:60

///////////////////////////////////////////////////////
///////////////////////////////////////////////////////

// in bellow line i'm tring to multiplay 2 values
let nm1 = 15 ; // 1st variabe 
let nm2 = 2 ;  // 2nd variable 

let mul = nm1 * nm2 * 2 ; //multiplay numbers using the +operator.

console.log(mul);   // Output:60
