...
var message = "".concat(famous_person, " once said, \"I have no special talent. I am only passionately curious.\"");
console.log(message);
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// task 6
...
var message = "My Name is ".concat(personName, ", i'm a PHP full skack devoloper.");
...
for (var i = 0; i < guestList.length; i++) {
    console.log("Dear ".concat(guestList[i], ", you are cordially invited to dinner at my place. Please var me know if you can attend."));
}
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// Task 15
...
console.log("Unfortunately, ".concat(unavailableGuest, " can't make it to dinner."));
// Replace the unavailable guest with the new guest
guestList[indexOfUnavailableGuest] = newGuest;
// Send out new invitations
for (var i = 0; i < guestList.length; i++) {
...
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
var guestList = ["Ali Babar", "Babar Ali", "Jabbar"];
var maxGuests = 2;
...
for (var i = 0; i < guestList.length; i++) {
    console.log("Dear ".concat(guestList[i], ", you are still invited to dinner at my place."));
}
...
function make_great(names) {
    ...
    for (var _i = 0, names_3 = names; _i < names_3.length; _i++) {
        var name = names_3[_i];
        great_names.push("the Great ".concat(name));
    }
    return great_names;
}
// Creating an array of magician's names
